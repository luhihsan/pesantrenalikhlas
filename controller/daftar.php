<?php
    ...
    // $querypendaftar = mysqli_query($connect, "INSERT INTO pendaftarawal VALUES('$no_pendf','$id', '$nama', '$tgllahir', '$nisn', '$alamat', '10', '10', '10', '$asal_sekolah', '$tempat_lahir', '$nama_ayah', '$nama_ibu', '$program')");
