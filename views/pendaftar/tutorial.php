        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link " href="../pendaftar/?beranda">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../pendaftar/tutorial.php">Tutorial</a>
                    <li class="nav-item">
            ...
            <div class="row p-4">
                ...
                <div class="col text-center">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="../pendaftar/?daftarsiswa" class="text-light">Pemeringkatan</a></li>
                    </ul>
                </div>
            </div>
        </div>
